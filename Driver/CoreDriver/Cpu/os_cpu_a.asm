...
;*******************************************************************************/
        ...
        IMPORT  CurrentRunThreadNext
        IMPORT  CurrentRunThread
        IMPORT  ThreadSwtTarget
        IMPORT  OSThreadSwtHook
...
PendSV_Handler
    ...
    LDR     R1, =CurrentRunThread                               ; CurrentRunThread->OSTDSStkPtr = SP;
    LDR     R1, [R1]
    STR     R0, [R1]                                            ; R0 is SP of process being switched out

                                                                ; At this point, entire context of process has been saved
PendSV_Handler_Nosave
    LDR     R0, =CurrentRunThread                                       ; OSTCBCur  = OSTCBHighRdy;
    LDR     R1, =ThreadSwtTarget
    LDR     R2, [R1]
    STR     R2, [R0]
	
	PUSH    {R14}                                               ; Save LR exc_return value
    LDR     R0, =OSThreadSwtHook                                ; OSThreadSwtHook();
    BLX     R0
    POP     {R14}
